var jsAnimate = function () {
    ...
    function fade() {
        ...
        for (var i = 0; i < lazyDocuments.length; i++) {
            ...
            else if (lazyDocuments[i].classList.contains("fadein-right")) {
                lazyDocuments[i].style.transform = "translateX(300px)"
                direction = "right"
                reverse = undefined
            }
            else if (lazyDocuments[i].classList.contains("fadein-top")) {
                lazyDocuments[i].style.transform = "translateY(-300px)"
                direction = "top"
                reverse = undefined
            }
            else if (lazyDocuments[i].classList.contains("fadein-bottom")) {
                lazyDocuments[i].style.transform = "translateY(300px)"
                direction = "bottom"
                reverse = undefined
            }
            else if (lazyDocuments[i].classList.contains("fadein-left-r")) {
                lazyDocuments[i].style.transform = "translateX(-300px)"
                direction = "left"
                reverse = true
            }
            else if (lazyDocuments[i].classList.contains("fadein-right-r")) {
                lazyDocuments[i].style.transform = "translateX(300px)"
                direction = "right"
                reverse = true
            }
            else if (lazyDocuments[i].classList.contains("fadein-top-r")) {
                lazyDocuments[i].style.transform = "translateY(-300px)"
                direction = "top"
                reverse = true
            }
            else if (lazyDocuments[i].classList.contains("fadein-bottom-r")) {
                lazyDocuments[i].style.transform = "translateY(300px)"
                direction = "bottom"
                reverse = true
            }
            else if (lazyDocuments[i].classList.contains("lazyfade-r")) {
                direction = "fade"
                reverse = true
            }
            else {
            ...
            lazyNodeArray.forEach(function (lazyNode) {
                ...
                if (!lazyNode.reverse) {
                    if (lazyNode.offsetTop <= clientHeight && lazyNode.offsetTop >= 0) {
                        ...
                        lazyNode.node.style.transform = "translate(0,0)"
